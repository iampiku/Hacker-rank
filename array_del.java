...
class duplicate_element{
    ...
    // we are using hashSet to delete duplicate elements of the array as hashSet has a property that it will not allow repeated element to enter into the set thus avoiding duplication;
    void methos_2(){
